...
public class FileAdapter extends RecyclerView.Adapter<FileAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_files,parent,false);
    ...
    public void onBindViewHolder(FileAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(selectedFile.isDirectory()){
                    FilesFragment filesFragment = FilesFragment.newInstance(selectedFile.getAbsolutePath());
                    FragmentManager fragmentManager = ((AppCompatActivity) context).getSupportFragmentManager();
                    fragmentManager.beginTransaction()
                            .replace(R.id.recycler_view , filesFragment)
                            .addToBackStack(null)
                            .commit();
                }else{
                    try {
